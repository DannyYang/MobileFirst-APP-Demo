...
/* JavaScript content from js/controllers/mainPageCtrls/MP0601ViewCtrl.js in folder common */
app.controller('MP0601ViewCtrl', function($scope, $ionicLoading, $cordovaDevice, APIService) {

    var UUID = $cordovaDevice.getDevice().uuid;
    var fileUploadURL = "http://140.124.183.164:8080/ServletFileUploadSample/upload?file=";
